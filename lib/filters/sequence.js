...
module.exports = ( function () {
     ...
     * discarding an element, parsed from the random source, decreases; then, the algorithm
     * approach is to copy an entire slice of good values, only when it encounters a value
     * not in the selected range; so it is faster than copying a value at a time.
     *
     * Example :
     *
     ...
     *    of random data to get a value, but it doesn't accept all values in the range
     *    [32, 65535]; then, after cutting (7) bits from the first (left-most) byte,
     *    the range will be restricted to [0, 63], now the probability of discarding a
     *    parsed value, will be always ~<=0.5.
     */
