...
module.exports = ( function () {
    ...
    var log = console.log
        ...
        , Sequence = function ( i, r ) {
            ...
            me.bitmap = null;
            // write the range value to a Buffer for faster comparisons when parse data
    ...
    sproto.parse = function ( data ) {
        var me = this
            ...
            ;
        /*
         * Parse the input data, if there wasn't enough information to fill
         * the result buffer, it exits emitting emits 'feed' event, together
         * with a number that represents the remaining bytes to write.
         * Firstly, before reading a byte or a multibyte value, cut left-most
         * bits from the first (left-most) byte, then copy the value to result,
         * but only if it's in the current range.
         * If results are available, it emits 'fart' with the result Buffer.
         */
