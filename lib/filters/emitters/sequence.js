...
module.exports = ( function () {
     ...
     */
    sproto.parse = function ( data, items ) {
        var me = this
            , bcomp = me.bcompare
            , result = me.result
            , tbytes = me.tbytes
            ...
            ;
/**/
        me.left = items >>> 0 ? min( abs( items ), me.left ) : ( tbytes - me.wpos ) / ibytes;
rbytes = me.left * ibytes;

log( me.left, items, rbytes)
        ...
        // TODO, ratio and feed bytes
        ratio = tbytes < o ? tbytes / o : 1;
        return me.left ?
               me.emit( 'feed', tbytes - me.wpos, ratio ) :
               me.emit( 'fart', me.result.slice( 0, me.wpos ), ratio )
               ;
